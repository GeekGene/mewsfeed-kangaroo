...
pub const DEFAULT_NETWORK_SEED: Option<&str> = Some("2023-10-10");  // replace-me (optional): Depending on your application, you may want to put a network seed here or
